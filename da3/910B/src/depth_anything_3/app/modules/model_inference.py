...
from depth_anything_3.utils.memory import cleanup_npu_memory
...
class ModelInference:
    ...
    def initialize_model(self, device: str = "npu") -> None:
        """
    ...
    # cleanup() removed: call cleanup_npu_memory() directly where needed.
