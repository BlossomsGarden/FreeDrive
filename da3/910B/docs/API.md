...
model = DepthAnything3.from_pretrained("depth-anything/DA3NESTED-GIANT-LARGE").to("npu")
...
model = DepthAnything3(model_name="da3-giant").to("npu")
...
model = model.to("npu")  # Move to GPU
```
