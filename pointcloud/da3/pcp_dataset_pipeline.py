...
# ------------------------------
if HAS_NPU:
    data_root_base = "/home/ma-user/modelarts/user-job-dir/wlh/code/FreeDrive/vda/toy_data"  # Base directory containing multiple data folders
    model_path = "/home/ma-user/modelarts/user-job-dir/wlh/model/da3nested-giant-large"
    output_base = "/home/ma-user/modelarts/user-job-dir/wlh/data/PointCloudPainter/waymo/PCP_trainer"
else:
...
camera_offset = [1.0, 0.0, 0.0]   # Forward 1 meter
